...
Using this list of items [${testItems}], categorize and group them based on their relevance to common grocery store aisle names.
    ...
    useEffect(() => {
        ...
        const getChatGPTRes = async () => {
            try {
                ...
                // let organizedList = Object.entries(chatGPTRes).map(([category, items]) => {
                //     console.log(`Category: ${category}`);
                //     items.map(item => console.log(`Items: ${item}`));
                //   });
...
// {Bakery: Array(1), Baking: Array(1), Beverages: Array(1), Canned and Jarred Goods: Array(1), Condiments: Array(1), …}
// Bakery
// : 
// ['bread']
// Baking
...
// Produce
// : 
// (2) ['avocados', 'garlic powder']
// Snacks
// : 
// (3) ['chips', 'crackers', 'peanut butter']
// Spices & Seasonings
// : 
// (3) ['salt', 'baking soda', 'garlic powder']